...
$pets->updated_at = $data->updated_at;
    ...
    if($lastInsertedId!=0){
		...
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create pets","document"=> ""));
    }
}
else{
    http_response_code(400);
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create pets. Data is incomplete.","document"=> ""));
}
?>
