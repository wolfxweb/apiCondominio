...
public $cond_nome;
	...
	function search_count($searchKey) {
		$query = "SELECT count(1) as total FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE LOWER(t.pets_nome) LIKE ? OR LOWER(t.pets_raca) LIKE ?  OR LOWER(t.pets_tipo) LIKE ?  OR LOWER(t.unid_id) LIKE ?  OR LOWER(t.cond_id) LIKE ?  OR LOWER(t.created_at) LIKE ?  OR LOWER(t.updated_at) LIKE ? ";
		$stmt = $this->conn->prepare($query);
...
$stmt->bindParam(7, $searchKey);
	...
	function search_record_count($columnArray,$orAnd){
		...
		$query = "SELECT count(1) as total FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE ".$where."";
	...
	function read(){
		...
		$query = "SELECT  uuu.unid_name, aa.cond_nome, t.* FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
		$stmt = $this->conn->prepare($query);
		$stmt->execute();
		return $stmt;
	}
	function search($searchKey){
		...
		$offset = ($this->pageNo-1) * $this->no_of_records_per_page; 
		$query = "SELECT  uuu.unid_name, aa.cond_nome, t.* FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE LOWER(t.pets_nome) LIKE ? OR LOWER(t.pets_raca) LIKE ?  OR LOWER(t.pets_tipo) LIKE ?  OR LOWER(t.unid_id) LIKE ?  OR LOWER(t.cond_id) LIKE ?  OR LOWER(t.created_at) LIKE ?  OR LOWER(t.updated_at) LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
		$stmt = $this->conn->prepare($query);
		$searchKey="%".strtolower($searchKey)."%";
...
$stmt->bindParam(7, $searchKey);
	...
	function searchByColumn($columnArray,$orAnd){
		...
		$query = "SELECT  uuu.unid_name, aa.cond_nome, t.* FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE ".$where." LIMIT ".$offset." , ". $this->no_of_records_per_page."";
	...
	function readOne(){
		$query = "SELECT  uuu.unid_name, aa.cond_nome, t.* FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE t.id = ? LIMIT 0,1";
		$stmt = $this->conn->prepare($query);
...
$this->pageNo =$_GET["pageNo"]; } 
$offset = ($this->pageNo - 1) * $this->no_of_records_per_page;
$query = "SELECT  uuu.unid_name, aa.cond_nome, t.* FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE t.unid_id = ? LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$this->pageNo =$_GET["pageNo"]; } 
$offset = ($this->pageNo - 1) * $this->no_of_records_per_page;
$query = "SELECT  uuu.unid_name, aa.cond_nome, t.* FROM ". $this->table_name ." t  join unidades uuu on t.unid_id = uuu.id  join condominios aa on t.cond_id = aa.id  WHERE t.cond_id = ? LIMIT ".$offset." , ". $this->no_of_records_per_page."";
