...
public $cond_nome;
	...
	function search_count($searchKey) {
		$query = "SELECT count(1) as total FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE LOWER(t.visi_nome) LIKE ? OR LOWER(t.visi_cpf) LIKE ?  OR LOWER(t.visi_rg) LIKE ?  OR LOWER(t.visi_telefone) LIKE ?  OR LOWER(t.visi_obs) LIKE ?  OR LOWER(t.unid_id) LIKE ?  OR LOWER(t.cond_id) LIKE ?  OR LOWER(t.created_at) LIKE ?  OR LOWER(t.updated_at) LIKE ? ";
		$stmt = $this->conn->prepare($query);
...
$stmt->bindParam(9, $searchKey);
	...
	function search_record_count($columnArray,$orAnd){
		...
		$query = "SELECT count(1) as total FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE ".$where."";
	...
	function read(){
		...
		$query = "SELECT  n.unid_name, pp.cond_nome, t.* FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
		$stmt = $this->conn->prepare($query);
		$stmt->execute();
		return $stmt;
	}
	function search($searchKey){
		...
		$offset = ($this->pageNo-1) * $this->no_of_records_per_page; 
		$query = "SELECT  n.unid_name, pp.cond_nome, t.* FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE LOWER(t.visi_nome) LIKE ? OR LOWER(t.visi_cpf) LIKE ?  OR LOWER(t.visi_rg) LIKE ?  OR LOWER(t.visi_telefone) LIKE ?  OR LOWER(t.visi_obs) LIKE ?  OR LOWER(t.unid_id) LIKE ?  OR LOWER(t.cond_id) LIKE ?  OR LOWER(t.created_at) LIKE ?  OR LOWER(t.updated_at) LIKE ?  LIMIT ".$offset." , ". $this->no_of_records_per_page."";
		$stmt = $this->conn->prepare($query);
		$searchKey="%".strtolower($searchKey)."%";
...
$stmt->bindParam(9, $searchKey);
	...
	function searchByColumn($columnArray,$orAnd){
		...
		$query = "SELECT  n.unid_name, pp.cond_nome, t.* FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE ".$where." LIMIT ".$offset." , ". $this->no_of_records_per_page."";
	...
	function readOne(){
		$query = "SELECT  n.unid_name, pp.cond_nome, t.* FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE t.id = ? LIMIT 0,1";
		$stmt = $this->conn->prepare($query);
...
$this->pageNo =$_GET["pageNo"]; } 
$offset = ($this->pageNo - 1) * $this->no_of_records_per_page;
$query = "SELECT  n.unid_name, pp.cond_nome, t.* FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE t.unid_id = ? LIMIT ".$offset." , ". $this->no_of_records_per_page."";
...
$this->pageNo =$_GET["pageNo"]; } 
$offset = ($this->pageNo - 1) * $this->no_of_records_per_page;
$query = "SELECT  n.unid_name, pp.cond_nome, t.* FROM ". $this->table_name ." t  join unidades n on t.unid_id = n.id  join condominios pp on t.cond_id = pp.id  WHERE t.cond_id = ? LIMIT ".$offset." , ". $this->no_of_records_per_page."";
