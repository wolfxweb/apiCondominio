...
$convidados->updated_at = $data->updated_at;
 	$lastInsertedId=$convidados->create();
    if($lastInsertedId!=0){
		...
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create convidados","document"=> ""));
    }
}
else{
    http_response_code(400);
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create convidados. Data is incomplete.","document"=> ""));
}
?>
