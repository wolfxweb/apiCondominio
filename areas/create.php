...
$areas->updated_at = $data->updated_at;
    ...
    if($lastInsertedId!=0){
		...
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create areas","document"=> ""));
    }
}
else{
    http_response_code(400);
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create areas. Data is incomplete.","document"=> ""));
}
?>
