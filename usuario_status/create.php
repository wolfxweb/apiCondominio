...
$usuario_status->usus_sigla = 'A';
 	...
 	$lastInsertedId=$usuario_status->create();
    if($lastInsertedId!=0){
		...
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create usuario_status","document"=> ""));
    }
}
else{
    http_response_code(400);
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create usuario_status. Data is incomplete.","document"=> ""));
}
?>
