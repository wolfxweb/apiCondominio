...
$ocorrencias->updated_at = $data->updated_at;
 	$lastInsertedId=$ocorrencias->create();
    if($lastInsertedId!=0){
		...
		echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create ocorrencias","document"=> ""));
    }
}
else{
    http_response_code(400);
	echo json_encode(array("status" => "error", "code" => 0,"message"=> "Unable to create ocorrencias. Data is incomplete.","document"=> ""));
}
?>
