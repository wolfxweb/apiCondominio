...
$unidade_medida->usu_id = isset($_GET['usu_id']) ? $_GET['usu_id'] : die();

$stmt = $unidade_medida->readByusu_id();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $unidade_medida_arr["total_count"]=$unidade_medida->total_record_count();
