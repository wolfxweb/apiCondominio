...
$achados_perdidos->cond_id = isset($_GET['cond_id']) ? $_GET['cond_id'] : die();

$stmt = $achados_perdidos->readBycond_id();
$num = $stmt->rowCount();
...
if($num>0){
    ...
    $achados_perdidos_arr["total_count"]=$achados_perdidos->total_record_count();
